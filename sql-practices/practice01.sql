...
select first_name as '이름', gender as '성별', birth_date as '입사일' from employees order by birth_date;
...
select distinct dept_name from departments order by char_length(dept_name);
